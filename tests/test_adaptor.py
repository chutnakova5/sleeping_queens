...
class TestPlay(TestCase):
    ...
    def test_potion(self):
        self.player1.hand.cards[0] = self.cards1[0] = Card(CardType.WAND, 0)
        self.player2.hand.cards[0] = self.cards2[0] = Card(CardType.POTION, 0)
        ...
        # 8 1 dragon king *             ---         7 3 knight potion *
        self.assertEqual(self.player2.hand.cards[:-2], self.cards2[1:4])
        self.assertEqual(self.player1.hand.cards[:-2], self.cards1[1:4])
