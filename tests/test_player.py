...
class TestPlayerSolitary(TestCase):
    def setUp(self) -> None:
        ...
        mock_hand = Mock()
        self.player = Player(mock_hand, Mock(), Mock(), Mock(), Mock())
        self.playerID = 0

        self.numbers_ok1 = [HandPosition(Card(CardType.NUMBER, 7), self.playerID)]
        self.numbers_ok2 = [HandPosition(Card(CardType.NUMBER, 1), self.playerID),
                            HandPosition(Card(CardType.NUMBER, 1), self.playerID)]
        self.numbers_ok3 = [HandPosition(Card(CardType.NUMBER, 5), self.playerID),
                            HandPosition(Card(CardType.NUMBER, 1), self.playerID),
                            HandPosition(Card(CardType.NUMBER, 7), self.playerID),
                            HandPosition(Card(CardType.NUMBER, 1), self.playerID)]

        self.numbers_w1 = [HandPosition(Card(CardType.NUMBER, 10), self.playerID)]
        self.numbers_w2 = [HandPosition(Card(CardType.NUMBER, 1), self.playerID),
                           HandPosition(Card(CardType.NUMBER, 3), self.playerID)]
        self.numbers_w3 = [HandPosition(Card(CardType.NUMBER, 3), self.playerID),
                           HandPosition(Card(CardType.NUMBER, 5), self.playerID),
                           HandPosition(Card(CardType.NUMBER, 1), self.playerID)]
        self.numbers_w4 = [HandPosition(Card(CardType.NUMBER, 5), self.playerID),
                           HandPosition(Card(CardType.KING, 0), self.playerID)]

        self.cards_ok1 = [HandPosition(Card(CardType.POTION, 0), self.playerID),
                          AwokenQueenPosition(Queen('Rose Queen', 5), Mock())]
        self.cards_ok2 = [HandPosition(Card(CardType.KING, 0), self.playerID),
                          SleepingQueenPosition(Queen('Rose Queen', 5))]
        self.cards_w1 = [HandPosition(Card(CardType.KING, 0), self.playerID),
...
class TestPlayerSociable(TestCase):
    def setUp(self):
        ...
        self.numbers_ok1 = [HandPosition(Card(CardType.NUMBER, 7), 0)]
        self.numbers_ok2 = [HandPosition(Card(CardType.NUMBER, 1), 0),
                            HandPosition(Card(CardType.NUMBER, 1), 0)]
        self.numbers_ok3 = [HandPosition(Card(CardType.NUMBER, 5), 0),
                            HandPosition(Card(CardType.NUMBER, 1), 0),
                            HandPosition(Card(CardType.NUMBER, 7), 0),
                            HandPosition(Card(CardType.NUMBER, 1), 0)]

        self.numbers_w1 = [HandPosition(Card(CardType.NUMBER, 10), 0)]
        self.numbers_w2 = [HandPosition(Card(CardType.NUMBER, 1), 0),
                           HandPosition(Card(CardType.NUMBER, 3), 0)]
        self.numbers_w3 = [HandPosition(Card(CardType.NUMBER, 3), 0),
                           HandPosition(Card(CardType.NUMBER, 5), 0),
                           HandPosition(Card(CardType.NUMBER, 1), 0)]
        self.numbers_w4 = [HandPosition(Card(CardType.NUMBER, 5), 0),
                           HandPosition(Card(CardType.KING, 0), 0)]
        self.numbers_w5 = [HandPosition(Card(CardType.NUMBER, 1), 0),
                           HandPosition(Card(CardType.NUMBER, 3), 1)]

        self.cards_ok1 = [HandPosition(Card(CardType.POTION, 0), 0),
                          AwokenQueenPosition(Queen('Rose Queen', 5), 1)]
        self.cards_ok2 = [HandPosition(Card(CardType.KING, 0), 0),
                          SleepingQueenPosition(Queen('Moon Queen', 10))]
        self.cards_w1 = [HandPosition(Card(CardType.KING, 0), 0),
                         HandPosition(Card(CardType.POTION, 0), 1)]
    ...
    def test_awoken_queens(self):
        ...
        queens = self.player.awoken_queens.get_queens()
    ...
    def test_play(self):
        ...
        self.other_player.hand.cards = [number2, potion2, king2, dragon2, wand2]
        self.assertFalse(self.player.play([HandPosition(knight1, 0),
                                           AwokenQueenPosition(queen2, 1)]))
        self.assertTrue(self.player.play([HandPosition(knight11, 0),
                                          AwokenQueenPosition(queen2, 1)]))
    ...
    def test_play_numbered(self):
        ...
        self.numbers_ok1 = [HandPosition(cards[0], 0)]
        self.numbers_ok2 = [HandPosition(cards[1], 0), HandPosition(cards[4], 0)]
        self.numbers_ok3 = [HandPosition(cards[3], 0), HandPosition(cards[1], 0),
                            HandPosition(cards[0], 0), HandPosition(cards[4], 0)]
        self.numbers_w1 = [HandPosition(Card(CardType.NUMBER, 10), 0)]
        self.numbers_w2 = [HandPosition(cards[1], 0),
                           HandPosition(cards[2], 0)]
        self.numbers_w3 = [HandPosition(cards[2], 0),
                           HandPosition(cards[3], 0),
                           HandPosition(cards[4], 0)]
        self.numbers_w4 = [HandPosition(cards[3], 0),
                           HandPosition(Card(CardType.KING, 0), 0)]
        self.numbers_w5 = [HandPosition(cards[1], 0),
                           HandPosition(cards[2], 1)]
